            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="product-details">
                        ...
                        <div>
                            <h3 class="product-price">{{ $product->price }}<del class="product-old-price">29.999.000</del>
                            </h3>
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="product">
                        <div class="product-img">
                            <img src="/client/img/pro9.jpg" alt="">
                        </div>
                        <div class="product-body">
                            <p class="product-category"></p>
                            <h3 class="product-name"><a href="#">{{$product->name}}</a></h3>
                            <h4 class="product-price">{{$product->price}}<del class="product-old-price">2900000</del></h4>
                            <div class="product-rating">
                            </div>
                            <div class="product-rating">
                                <i class="fa fa-star"></i>
